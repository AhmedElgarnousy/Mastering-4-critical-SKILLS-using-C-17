...
/*
Homework 6: Be Careful!
- In this code, which lines of code don’t compile. Why?
- Which lines of code cause RTE?
*/
 ...
 * 	B) As a return: Never return & (or const &) for a local variable as it will be destroyed. This will cause RTE.
 *      The is the most dangerous case, as others cause compile error.
 * 	C) You can return & to data member as it won't be destroyed before the receiving variable.
 *      But better use const & to follow OO concepts as possible
