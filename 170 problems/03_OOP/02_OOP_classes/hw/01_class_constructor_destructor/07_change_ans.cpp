...
// It might be a good practice to depend on the available setters
// and getters
// Imagine a real Time class with 20 functions that use minutes,
// which now doesn't exist
// If they all use GetMinutes, no one of them will be changed
// Be careful with data members that might change or keep depending
//  on setters/getters
// As you see, we could even provide setters & getters for
