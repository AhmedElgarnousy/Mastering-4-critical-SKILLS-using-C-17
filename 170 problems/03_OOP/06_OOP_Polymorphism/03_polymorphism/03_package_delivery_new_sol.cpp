...
public:
    StandardPackage(const Address &sender_address, const Address &reciever_address, double weight_kg, double price_per_kg) : sender_address(sender_address), reciever_address(reciever_address), weight_kg(weight_kg), price_per_kg(price_per_kg)
    {
    }
...
public:
    TwoDayPackage(const Address &sender_address, const Address &reciever_address, double weight_kg, double price_per_kg, double fixed_fee) : StandardPackage(sender_address, reciever_address, weight_kg, price_per_kg), fixed_fee(fixed_fee)
    {
    }
...
public:
    HeavyPackage(const Address &sender_address, const Address &reciever_address, double weight_kg, double price_per_kg, double extra_price_per_kg) : StandardPackage(sender_address, reciever_address, weight_kg, price_per_kg), extra_price_per_kg(extra_price_per_kg)
    {
    }
